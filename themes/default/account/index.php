...
<form action="<?php echo $this->url ?>" method="get" class="search-form">
	...
	<p>
		<label for="use_birth_start"><?php echo htmlspecialchars(Flux::message('BirthDateBetweenLabel')) ?>:</label>
		<input type="checkbox" name="use_birth_start" id="use_birth_start"<?php if ($params->get('use_birth_start')) echo ' checked="checked"' ?> />
		<?php echo $this->dateField('birth_start') ?>
		<label for="use_birth_end">&mdash;</label>
		<input type="checkbox" name="use_birth_end" id="use_birth_end"<?php if ($params->get('use_birth_end')) echo ' checked="checked"' ?> />
		<?php echo $this->dateField('birth_end') ?>	
		...
...
<table class="horizontal-table">
	<tr>
		...
		<th><?php echo $paginator->sortableColumn('birthdate', Flux::message('BirthDateLabel')) ?></th>
	...
	<tr>
		...
		<td><?php echo $this->formatDate($account->birthdate); ?></td>
